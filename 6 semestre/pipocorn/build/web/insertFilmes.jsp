...
<%
    ...
    if(nome != null){
        ...
        Filmes filmes = new Filmes(nome,link,genero,foto);
                        
        FilmesController recController = new FilmesController();
        recController.NovoFilmes(filmes);
    ...
    <!-- Main -->
        <div id="main">
            ...
            <form class="forms" method="post" action="#">
                <input type="text" name="nome" value="" class="form-control" placeholder="Nome do filme" > <br /><br />
                ...
                <input class="btnForm" id="btnCadastro" type="submit" value="adcionar filme">
            </form>
        </div>
    </body>
</html>